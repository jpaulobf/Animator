...
public class LoadingImpl implements Loading {
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.Loading#draw(java.awt.Graphics2D)
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.Loading#update()
	 */
	public void update() {
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.Loading#updateCanvasProperties(boolean, java.lang.Integer, java.lang.Integer, java.lang.Integer)
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.Loading#resetCounters()
	 */
