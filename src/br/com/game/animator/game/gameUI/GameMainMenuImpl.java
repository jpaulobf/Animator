...
public class GameMainMenuImpl implements GameMainMenu {
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameMainMenu#update()
	 */
	public void update() {
		//---------------------------------------------------------//
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameMainMenu#updateGraphics(boolean, java.lang.Integer, java.lang.Integer)
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameMainMenu#resetCounters()
	 */
