...
public class GameOptionScreenImpl implements GameOptionScreen {
	...
	public GameOptionScreenImpl(GameOptions parentGameOption, Integer pwidth, Integer pheight, Integer currentAspectRatio) {
		...
		this.backgroundGameOptions			= this.imageUtil.loadImage("/res/images/bg_option_screen2.png");
		this.gameOptionsLogo				= this.imageUtil.loadImage("/res/images/logo_game_options.png");
		this.highlightButton				= this.imageUtil.loadImage("/res/images/optg_gameoption_selector.png");
		this.labelGameDifficulty			= this.imageUtil.loadImage("/res/images/optg_game_difficulty_label.png");
		this.labelRests						= this.imageUtil.loadImage("/res/images/optg_rest_label.png");
		this.labelExtraLifeAt				= this.imageUtil.loadImage("/res/images/optg_extra_life_label.png");
		this.labelContinues					= this.imageUtil.loadImage("/res/images/optg_continues_label.png");
		this.labelEnableSubtitles			= this.imageUtil.loadImage("/res/images/optg_game_subtitles_label.png");
		...
		this.imageGameDifficulty			= this.imageUtil.loadImage("/res/images/optg_easy_normal_hard_label.png");
		...
		this.imageGameRestsStrip			= this.imageUtil.loadImage("/res/images/optg_rest_values_label.png");
		...
		this.imageGameContinuesStrip		= this.imageUtil.loadImage("/res/images/optg_continue_values_label.png");
		...
		this.imageGameExtraLifeStrip		= this.imageUtil.loadImage("/res/images/optg_extra_life_values_label.png");
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameOptionScreen#update()
	 */
	public void update() {
		//---------------------------------------------------------//
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameOptionScreen#drawOptionScreen(java.awt.Graphics2D)
	 */
	public void drawOptionScreen(Graphics2D g2d) {
		...
		//---------------------------------------------------------//
		//--- Desenha a label N�o (para subtitles).				---//
		//---------------------------------------------------------//
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameOptionScreen#updateGraphics(boolean, java.lang.Integer, java.lang.Integer)
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameOptionScreen#resetCounters()
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameOptionScreen#nextOption()
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameOptionScreen#previousOption()
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameOptionScreen#isOverGameDifficulty()
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameOptionScreen#isOverRestsSelection()
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameOptionScreen#isOverExtraLifeSelection()
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameOptionScreen#isOverContinuesSelection()
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameOptionScreen#isOverEnableSubtitles()
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameOptionScreen#isToBackToMainOption()
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameOptionScreen#setNextDifficulty()
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameOptionScreen#setPreviousDifficulty()
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameOptionScreen#addRest()
	 */
	public void addRest() {
		if (this.parentGameOption.getGameRestNumber() < 9) {
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameOptionScreen#subRest()
	 */
	public void subRest() {
		if (this.parentGameOption.getGameRestNumber() > 4) {
			this.parentGameOption.setGameRestNumber(this.parentGameOption.getGameRestNumber() - 1);
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameOptionScreen#setNextExtraLifeAtPoints()
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameOptionScreen#setPreviousExtraLifeAtPoints()
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameOptionScreen#addContinues()
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameOptionScreen#subContinues()
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameOptionScreen#enableSubtitles()
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameOptionScreen#disableSubtitles()
	 */
