...
public class GameGraphicsScreenImpl implements GameGraphicsScreen {
	...
	public GameGraphicsScreenImpl(GameGraphics parentGameGraphicsOption, Integer pwidth, Integer pheight, Integer currentAspectRatio) {
		...
		//---------------------------------------------------------//
		//--- Guardo um clone do GameGraphics para as futuras	---//
		//--- atualiza��es.										---//
		//---------------------------------------------------------//
		...
		//--- Carrega as imagens.                         		---//
		//---------------------------------------------------------//
		this.backgroundGameOptions			= this.imageUtil.loadImage("/res/images/bg_option_screen5.png");
		this.gameOptionsLogo				= this.imageUtil.loadImage("/res/images/logo_graphics_config.png");
		this.highlightButton				= this.imageUtil.loadImage("/res/images/optg_gameoption_selector.png");
		this.labelScreenResolution			= this.imageUtil.loadImage("/res/images/gfx_screen_res_label.png");
		this.labelEnableTripleBuffer		= this.imageUtil.loadImage("/res/images/gfx_enable_triple_label.png");
		this.labelScreenMode				= this.imageUtil.loadImage("/res/images/gfx_screen_mode_label.png");
		this.labelDeepColor					= this.imageUtil.loadImage("/res/images/gfx_deep_color_label.png");
		this.labelApply						= this.imageUtil.loadImage("/res/images/gfx_apply_label.png");
		this.labelCancel					= this.imageUtil.loadImage("/res/images/gfx_cancel_label.png");
		this.screenResolutionStrip			= this.imageUtil.loadImage("/res/images/gfx_number_value.png");
		this.screenModeStrip				= this.imageUtil.loadImage("/res/images/gfx_screen_mode_value.png");
		this.deepColorStrip					= this.imageUtil.loadImage("/res/images/gfx_deep_colors_value.png");
		...
		this.buttonArrowLeft				= this.imageUtil.loadImage("/res/images/bt_arrow_left.png");
		this.buttonArrowRight				= this.imageUtil.loadImage("/res/images/bt_arrow_right.png");
		this.buttonArrowLeftWhite			= this.imageUtil.loadImage("/res/images/bt_arrow_left_white.png");
		this.buttonArrowRightWhite			= this.imageUtil.loadImage("/res/images/bt_arrow_right_white.png");
		...
		this.mustApplyForChanges			= this.imageUtil.loadImage("/res/images/gfx_must_apply.png");
		
		//TODO: VERIFICAR SE DESEJA MONTAR LISTA DE IMAGEM DE RESOLU��ES...
		
	}
	
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameGraphicsScreen#update()
	 */
	public void update() {
		//---------------------------------------------------------//
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameGraphicsScreen#drawGraphicsOptionScreen(java.awt.Graphics2D)
	 */
	public void drawGraphicsOptionScreen(Graphics2D g2d) {
		...
		//--- Desenha o valor selecionado do deep color. 		---//
		//---------------------------------------------------------//
		if (this.parentGameGraphicsOption.getScreenDeepColor() == null) {
		...
		if (this.parentGameGraphicsOption.getScreenDeepColor() == DeepColor.TRUE_COLOR_32_BITS) {
			image = this.deepColorValues[0];
		} else {
			image = this.deepColorValues[1];
		}
		g2d.drawImage(image, 
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameGraphicsScreen#updateGraphics(boolean, java.lang.Integer, java.lang.Integer)
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameGraphicsScreen#resetCounters()
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameGraphicsScreen#nextOption()
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameGraphicsScreen#previousOption()
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameGraphicsScreen#isOverScreenResolution()
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameGraphicsScreen#isOverEnableTripleBuffering()
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameGraphicsScreen#isOverScreenMode()
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameGraphicsScreen#isOverDeepColor()
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameGraphicsScreen#isToApply()
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameGraphicsScreen#isToBackToMainOption()
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameGraphicsScreen#nextScreenResolution()
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameGraphicsScreen#previousScreenResolution()
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameGraphicsScreen#enableTripleBuffer()
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameGraphicsScreen#disableTripleBuffer()
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameGraphicsScreen#nextScreenMode()
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameGraphicsScreen#previousScreenMode()
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameGraphicsScreen#nextScreenDeepColor()
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameGraphicsScreen#previousScreenDeepColor()
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameGraphicsScreen#applyChanges()
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.animator.gameUI.GameGraphicsScreen#cancelChanges()
	 */
