...
public final class Window extends JFrame {
    ...
    private boolean isScreenScaleAvailable(WindowScale scale) {
        int requiredWidth = switch (scale) {
            case X2 ->
                GlobalProperties.WINDOW_WIDTH_X2_4_3;
            case X3 ->
                GlobalProperties.WINDOW_WIDTH_X3_4_3;
            case X4 ->
                GlobalProperties.WINDOW_WIDTH_X4_4_3;
            default ->
                0;
        };
    ...
    /**
     * Initializes the buffer strategy in a background thread with proper
     * timeout handling.
     */
    ...
    /**
     * Realiza o polling dos eventos de Joystick. Deve ser chamado no loop
     * principal (Game.update).
     */
    ...
    /**
     * Checks if the window is ready for rendering. Call this in your Game Loop
     * to prevent IllegalStateException during transitions.
     *
