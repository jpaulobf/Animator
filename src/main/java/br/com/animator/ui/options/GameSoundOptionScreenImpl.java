...
import br.com.animator.game.ui.options.GameSoundOptionScreen;
...
public class GameSoundOptionScreenImpl implements GameSoundOptionScreen {
	...
	public GameSoundOptionScreenImpl(GameSoundOptions parentGameSoundOption, Integer pwidth, Integer pheight, Integer currentAspectRatio) {
		...
		this.backgroundGameOptions			= this.imageUtil.loadImage("/images/bg_option_screen4.png");
		this.gameOptionsLogo				= this.imageUtil.loadImage("/images/logo_sound_config.png");
		this.highlightButton				= this.imageUtil.loadImage("/images/optg_gameoption_selector.png");
		this.labelEnableMusic				= this.imageUtil.loadImage("/images/sound_enable_music_label.png");
		this.labelEnableSFX					= this.imageUtil.loadImage("/images/sound_enable_sfx_label.png");
		this.labelMusicVolume				= this.imageUtil.loadImage("/images/sound_music_volume_label.png");
		this.labelSFXVolume					= this.imageUtil.loadImage("/images/sound_sfx_volume_label.png");
		...
		this.imagesVolumes[0]				= this.imageUtil.loadImage("/images/volume_0.png");
		this.imagesVolumes[1]				= this.imageUtil.loadImage("/images/volume_1.png");
		this.imagesVolumes[2]				= this.imageUtil.loadImage("/images/volume_2.png");
		this.imagesVolumes[3]				= this.imageUtil.loadImage("/images/volume_3.png");
		this.imagesVolumes[4]				= this.imageUtil.loadImage("/images/volume_4.png");
		this.imagesVolumes[5]				= this.imageUtil.loadImage("/images/volume_5.png");
		this.imagesVolumes[6]				= this.imageUtil.loadImage("/images/volume_6.png");
		this.imagesVolumes[7]				= this.imageUtil.loadImage("/images/volume_7.png");
		this.imagesVolumes[8]				= this.imageUtil.loadImage("/images/volume_8.png");
		this.imagesVolumes[9]				= this.imageUtil.loadImage("/images/volume_9.png");
	}
